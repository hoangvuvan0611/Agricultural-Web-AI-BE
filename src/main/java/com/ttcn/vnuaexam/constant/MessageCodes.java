...
public class MessageCodes {
    ...
    public static final String EXCEL_EXTENSION_ERROR_MESSAGE = "Vui lòng upload file excel có định dạng .xls hoặc .xlsx.";
    ...
    public static class ImportStudent {
        ...
        public static final String CODE_STUDENT_JOINED = "Mã sinh viên %s đã có trong phòng từ trước. ";
        public static final String CODE_STUDENT_IS_NOT_EXISTED = "Mã sinh viên %s không tồn tại. ";
    }
}
